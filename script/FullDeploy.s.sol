...
/**
 * @title FullDeploy
 * @notice Complete deployment script for Cellux DEX with automatic role grants
...
contract FullDeploy is Script {
    ...
    CelluxToken public celluxToken;
    ...
    CelluxStaking public celluxStaking;
    ...
    function run() external {
        ...
        console.log("=================================================");
        console.log("Cellux DEX - Full Deployment Script");
        console.log("=================================================");
    ...
    function deployTokens() internal {
        ...
        // Deploy Cellux Token
        celluxToken = new CelluxToken();
        console.log("  CelluxToken deployed:", address(celluxToken));
    }
    ...
    function deployCoreContracts() internal {
        ...
        stabilityFund = new StabilityFund(address(mockUSDC), address(vaultPool), teamWallet);
    ...
    function deployAdvancedTrading() internal {
        ...
        oneTapProfit =
            new OneTapProfit(address(mockUSDC), address(stabilityFund), priceSignerWallet, keeperWallet, keeperWallet);
        console.log("  OneTapProfit deployed:", address(oneTapProfit));
    }

    function deployStakingContracts() internal {
        // Deploy CelluxStaking
        celluxStaking = new CelluxStaking(address(celluxToken), address(mockUSDC));
        console.log("  CelluxStaking deployed:", address(celluxStaking));
    }
    ...
    function setupRolesAndInitialize() internal {
        ...
        console.log("Granted EXECUTOR_ROLE on PositionManager to executors + relayer");
        ...
        console.log("Granted SETTLER_ROLE on StabilityFund to executors + relayer");
        ...
        console.log("Granted BACKEND_SIGNER_ROLE on MarketExecutor to price signer");
        ...
        console.log("Granted KEEPER_ROLE on TapToTradeExecutor to Keeper Wallet");

        console.log("\n  === Initializing Contracts ===");

        // Initialize CelluxToken distribution
        celluxToken.initialize(
            protocolTreasury, // Treasury allocation
            teamWallet, // Team allocation
            address(celluxStaking), // Staking rewards
            address(vaultPool) // Route liquidity mining allocation to vault pool
        );
        console.log("Initialized CelluxToken distribution");
        console.log("    - Treasury:", protocolTreasury, "- 1M CELL");
        console.log("    - Team:", teamWallet, "- 2M CELL");
        console.log("    - Staking:", address(celluxStaking), "- 5M CELL");
        console.log("    - Vault Pool (liquidity allocation):", address(vaultPool), "- 2M CELL");
    }
    ...
    function printDeploymentSummary() internal view {
        ...
        console.log("  CelluxToken:", address(celluxToken));
        ...
        console.log("\nStaking & Incentives:");
        console.log("  CelluxStaking:", address(celluxStaking));
        ...
        console.log("=================================================");
        console.log("\nNext Steps:");
        console.log("1. Copy addresses to cellux-be/.env");
        console.log("2. Fund VaultPool/StabilityFund with USDC liquidity");
        console.log("3. Test market orders on frontend");
        console.log("4. Verify contracts on MantleScan");
        console.log("=================================================\n");
    }
    ...
    function saveDeployment() internal {
        string memory json = string(
            abi.encodePacked(
                ...
                '",\n',
                '    "CelluxToken": "',
                vm.toString(address(celluxToken)),
                '",\n',
                '    "RiskManager": "',
                ...
                '",\n',
                '    "CelluxStaking": "',
                vm.toString(address(celluxStaking)),
                '"\n',
                "  },\n",
                '  "roles": {\n',
                '    "keeperWallet": "',
        ...
        string memory network =
            block.chainid == 5003 ? "mantle-sepolia" : block.chainid == 5000 ? "mantle-mainnet" : "unknown";
