...
contract MarketExecutor is AccessControl, ReentrancyGuard {
    ...
    function openMarketPosition(
        ...
        require(usdc.transferFrom(msg.sender, address(stabilityFund), collateral), "MarketExecutor: Transfer failed");
    ...
    function openMarketPositionMeta(
        ...
        require(usdc.transferFrom(trader, address(stabilityFund), collateral), "MarketExecutor: Transfer failed");
